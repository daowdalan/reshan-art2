...
const ArtworkItem = ({ artwork, handleProjectClick }) => {
  return (
    <li className="relative overflow-hidden rounded-lg shadow-md group cursor-pointer transition-transform transform hover:scale-105">
      <div className="relative w-full h-0 pb-[120%]"> {/* Portrait aspect ratio */}
        <Image
